...
// The type was already declared Optional and don't need to put '?' anymore.
...
// 'let' defines immutable and var defines mutable. Furthermore, the function should return a ture since its not an optional return. Finally it has to be a static method.
...
// 1. Delete the 'optional' because the function can only return true or false; 2. One of the right ways to declare a dictionary is dict = [datatype1: datatype2]; 3. It has to be a static method.
